// This function will begin when the window is loaded and will disable the stop button
...
// this function will roll and determine the starting player
function rollForTurn() {
    ...
    diceRoll(); // play dice sounds and show who rolled what
    for (i=0;i<xArray.length;i++) {
		var result = i + 1;
        var pOne = xArray[0];
		var pTwo = xArray[1];
		if (pOne == pTwo) { // was this resolved?
			pOne = 1;
			pTwo = 2;
		}
    	...
    	setTimeout(function() {writeMsg(txt1);}, 1000); // time delay for drama
    }
